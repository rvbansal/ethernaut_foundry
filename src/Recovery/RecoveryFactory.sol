...
contract RecoveryFactory is Level {
    ...
    function computeLostAddress(address _instance) public pure returns (address lostAddress) {
        ...
        lostAddress =
            address(uint160(uint256(keccak256(abi.encodePacked(bytes1(0xd6), bytes1(0x94), _instance, bytes1(0x01))))));
    }
