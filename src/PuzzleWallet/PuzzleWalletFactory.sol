...
contract PuzzleWalletFactory is Level {
    ...
    function createInstance(address) public payable override returns (address) {
        ...
        (bool successWhitelist1,) =
            address(instance).call(abi.encodeWithSignature("addToWhitelist(address)", address(1)));
        (bool successWhitelist2,) =
            address(instance).call(abi.encodeWithSignature("addToWhitelist(address)", address(this)));
